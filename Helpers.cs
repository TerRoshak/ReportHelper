...
namespace CB.Helpers.ReportHelper
{
    ...
    public static class Helpers
    {
        ...
        {
            PageResolution pr = Helpers.GetDefaultPrinterQueue().UserPrintTicket.PageResolution;
            return new Size((MM.Width / 25.4) * (double)pr.X, (MM.Height / 25.4) * (double)pr.Y);
        }
        ...
        {
            T newXaml = Helpers.LoadXAML<T>(Filename);
